...
function Hero() {
  return (
    <div className="border-b-2 border-black">
      <h1 className="text-[6.75rem] font-oswald uppercase text-center leading-[0.9] tracking-wider">
        The art magazine
      </h1>
      <p className="text-2xl mb-8 text-center py-2">
      ...
      <div className="py-16 w-3/4 flex justify-center mx-auto relative text-start">
        <div className="w-24 h-20 absolute -left-16 top-6 -z-10">
